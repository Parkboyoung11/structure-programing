...
2. Thiết kế có cấu trúc của phần mềm  
...
### Nhược điểm của lập trình có cấu trúc  
...
![Repetition structure](images/repetition_structure.png)  
![Repetition structure1](images/repetition_structure1.png)  
![Repetition structure2](images/repetition_structure2.png) 
...
### Các hàm và thủ tục làm phần tử chương trình  
...
1. Ví dụ: Mối quan tâm cốt lõi của hệ thống ngân hàng  
...
2. Ví dụ: Mối quan tâm chuyển tiền  
...
3. Ví dụ: Mối quan tâm thứ cấp của hệ thống ngân hàng  
...
4. Ví dụ: các mối quan tâm về xác thực, giao dịch và ghi nhật ký  
